        ...
        public void ChoosenCreturesFight()
        {
            ...
            while (firstFighter.CreatureHitPoints >= 0 && secondFighter.CreatureHitPoints >= 0)
            {
                if (firstFighter.Initiative > secondFighter.Initiative)
                {
                    ...
                    if (attackOfFirstFighter >= (int)(ArmorClass)Enum.Parse(typeof(ArmorClass), secondFighter.CreatureArmor.ToString()))
                    {
                    ...
                    if (attackOfSecondFighter >= (int)(ArmorClass)Enum.Parse(typeof(ArmorClass), firstFighter.CreatureArmor.ToString()))
                    {
